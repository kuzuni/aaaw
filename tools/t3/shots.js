...
const MEASURE = {
  ...
  perk: {
    ...
    /* ⚑⚑ T154 (주인 지시 2026-09-05 18:3X) — ref ⑦ 의 «상단 스탯 줄(8칸) x0 y4 w100 h6» 행이
     *   드디어 게임에 생겼다. 종전엔 대응물이 없어 늘 «없음» 이던 행이다. 칸 하나(첫 칸)도 같이 재
     *   «줄 높이·칸 폭·카드와의 간격» 을 레퍼런스 % 로 대조한다. */
    '상단 스탯 줄(8칸)': '⊕#overlay .ov-stats .sc', '상단 스탯 칸1': '#overlay .ov-stats .sc:nth-child(1)',
