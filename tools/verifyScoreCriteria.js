...
if (process.argv.includes('--self')) {
  const cases = [
    ...
    ['성장률 표를 T97 이전으로 되돌리면 (챕터 15 가 다시 100%)',
      s => s.replace('[[0,1.0292],[5,1.122],[15,1.1171],[20,1.0076],[30,1.0445],[50,1.0569],[70,1.0149],[120,1.0154],[260,1.0056]]',
        '[[0,1.0292],[15,1.15],[20,1.0096],[30,1.0565],[50,1.0724],[70,1.0188],[120,1.0154],[260,1.0056]]')
        .replace('[[0,1.0265],[5,1.122],[15,1.1082],[20,1.007],[30,1.0255],[50,1.0252],[70,1.0186],[120,1.0143],[260,1.0056]]',
