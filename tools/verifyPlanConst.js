...
const CHECKS=[
  ...
  /* ⚑⚑⚑ T104 — 최종 벽이 500 → 600 으로 옮겨졌다. 임계 자체도 이제 엔진 상수(`TUNE.wall4At`)라 대조 대상이다:
     문면과 임계가 따로 놀면 «PLAN 은 600 인데 엔진은 500 에서 벽» 을 아무도 못 잡는다. */
...
const TABLE=[];
{
  ...
  const SEG=[['1','5'],['5','15'],['15','20'],['20','30'],['30','50'],['50','70'],['70','120'],['120','260'],['260','600']];
  SEG.forEach(([a,b],i)=>{
