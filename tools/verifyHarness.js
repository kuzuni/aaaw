...
/* ⚑ 재보정 2 (T43, 2026-09-02T08:4XZ / 워커 B) — 사유: 주인 확정 «적 전원 회피 10%»(PLAN §2.3) 반영으로
   ...
   **하니스 자체는 다시 고르지 않았다**: 재측정에서 변별력 ①②③ 5항목이 전부 통과했다
   ...
   ⚠ 다만 실험2 하니스 55.0% 는 정본 ② 목표 밴드 60~70% 의 **허용치(±8%p) 하단 경계**다 —
   다음에 이 규모의 엔진 변경(회피·성장률·벽)이 또 오면 밴드를 벗어나므로, 그때는 기준선 갱신이 아니라
   **하니스 재선정(일반+7 → +8, 강화 축 +1강당 약 13%p)** 이 맞다. T1 몫으로 PROGRESS 에 등재. */
const BASELINE = {
  6: { har: { rar: 0, plus: 2, slot: 0 }, rate: 39.7, gap: -24.7 },
  8: { har: { rar: 0, plus: 7, slot: 0 }, rate: 55.0, gap: 29.5 },
};
