...
const PERK_NHIT_ARROW=2, PERK_NHIT_AXE=3, PERK_NHIT_BOLT=3, PERK_NHIT_SPEAR=3, PERK_NHIT_HEAL=3;
...
function mkPerks(){
  ...
  return [
    ...
    {id:'p_nHealN',    g:0,nm:'3타 회복',         d:'3타마다 최대 체력 5% 회복',        ap:p=>p.px.p_nHealN=1},
