...
const TUNE={
  ...
  eBaseHp:60.74137, eBaseDmg:11.183669,
  ...
  bossHp:4, bossDmg:1.5,        // 주인 확정 상수 (튜닝 노브 아님) — 5배수 챕터 추가 배수 폐기. ⚑⚑⚑ T168 (주인 확정 2026-09-05 23:4X «체력 4배 많고 공격력 1.5배 센 거로 해야 함 … 항상 그 수치로») — ×8·×1.8 → ×4·×1.5
