...
const TUNE={
  ...
  eHpSeg:[[0,1.0718],[15,1.0544],[30,1.0565],[50,1.0724],[70,1.0330],[120,1.0154]],
  eDmgSeg:[[0,1.0497],[15,1.0544],[30,1.0349],[50,1.0345],[70,1.0338],[120,1.0143]],
...
function exp1_rarityLadder(){
  const h=harness('EXP1_GEAR',0,1,0), CH=hCh('EXP1_CH',13);
...
function exp2_perkWinrate(){
  const h=harness('EXP2_GEAR',0,1,3), CH=hCh('EXP2_CH',11);
