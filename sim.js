...
/* ---- 3세트 × 6부위 옵션표 (PLAN §11.6 — ⚑⚑⚑ 주인 확정 T124 2026-09-04 19:2X) ----
   ...
   세 세트 공통이다 — **7번 = «흡혈 +8%» · 8번 = «공격력 +10%»**(⚑ 주인 확정 T145 2026-09-05 16:4X:
   «7번째 꺼는 흡혈로 해야 할 거 같은데 8퍼로» — 7번이 종전 «공격력 +10%» 에서 바뀌었다. 8번은 그대로).
   ...
   · «최대 체력 +8%»·«최대 실드 +10%»·«공격력 +10%» 는 **가산 합산**이다(곱연산 아님 — 주인 참고표의
     ...
     ⚑ T145 로 «공격력 +10%» 칸이 8번 하나만 남아 풀셋 +9강 공격력은 **+120% → +60%** 다(주인 확정의
     산술적 귀결 · 밸런스 조정 아님 — 상시 규칙대로 수치를 «맞추지» 않는다).
   · ⚑ «흡혈 +8%»(7번 · T145) 는 **부위마다 가산** — 풀셋 +6강 이상이면 `p.steal` 8×6 = **48**(= 준 피해의 48%).
...
function mkPlayer(build,G){
  ...
  /* ⚑ T124 — 세트 옵션의 퍼센트 축은 **가산 합산 뒤 한 번만** 곱한다(부위마다 곱연산으로 걸면 1.10^18 이 되어
     주인 수치와 어긋난다). ⚑ T145 로 «공격력 +10%» 칸이 8번 하나만 남아 풀셋 +9강은 공 **+60%** ·
     체 +48% · 실 +180% 다(7번 자리는 «흡혈 +8%» ×6 = p.steal 48). */
